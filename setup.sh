...
case "${OS}" in
	*Ubuntu*|*Debian*)
		echo "Setup for Debian/Ubuntu"
		sudo apt install build-essential flex bison python3-setuptools \
			swig python3-dev libssl-dev u-boot-tools python3-pyelftools git libncurses-dev
		;;

	*Fedora*)
		echo "Setup for Fedora/Redhat"
		sudo yum groupinstall 'Development Tools'
		sudo yum install python3-setuptools swig python3-devel openssl-devel \
			uboot-tools python3-pyelftools git ncurses-devel
		;;
